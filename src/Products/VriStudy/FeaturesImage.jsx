...
const featuresData = [
  {
    ...
    icon: Users,
    image: StudentDashboard, // Added image
    color: {
      bg: "bg-cyan-300",
      text: "text-cyan-300",
    },
  ...
  },
  {
    ...
    icon: Users,
    image: StudentProfile, // Added image
    color: {
      bg: "bg-yellow-300",
  ...
  },
  {
    ...
    icon: Building2,
    image: StudentUniversities, // Added image
    color: {
      bg: "bg-violet-300",
  ...
  },
  {
    ...
    icon: FileCheck2,
    image: StudentDocumnets, // Added image
    color: {
      bg: "bg-rose-300",
      text: "text-rose-300",
    },
  ...
  },
  {
    ...
    icon: ShieldCheck,
    image: DocumentsReview, // Added image
    color: {
      bg: "bg-lime-200",
      text: "text-lime-200",
    },
  ...
  },
  {
    ...
    icon: Smartphone,
    image: UniversityApplns, // Added image
    color: {
      bg: "bg-purple-200",
...
const FeaturesImage = () => {
  ...
  //                 src={selected.image} 
  //                 alt={selected.title}
  //                 className="max-w-full h-auto rounded-lg shadow-md object-contain max-h-80"
  //               />
  //             </div>
  //           </>
  //         )}
  ...
  //                 {/* Added Image for Mobile */}
  //                 <div className="mt-4 flex justify-center">
  //                   <img 
  //                     src={item.image} 
  //                     alt={item.title}
  //                     className="max-w-full h-auto rounded-lg shadow-md object-contain max-h-60"
  //                   />
  //                 </div>
  //               </div>
  //             )}
  ...
  <div id="Features" className="pt-10 px-4">
    ...
    <div className="md:hidden max-w-2xl mx-auto space-y-3">
      ...
      {/* Image Card for Mobile - White Background */}
      {selected && (
        <div className="">
          <img 
            src={selected.image} 
