...
const TrustedBy = () => {
    return (
        <div className='lg:pt-76 sm:pt-60 pt-40'>
            <div className="max-w-7xl mx-auto lg:p-0 px-4">
                <h2 className="md:text-3xl text-2xl font-semibold text-center mb-6">Trusted by leading brands and retailers</h2>
